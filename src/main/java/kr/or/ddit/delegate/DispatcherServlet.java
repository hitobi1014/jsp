...
public class DispatcherServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 응답을 다른 jsp(servlet)에게 위임하는 방법 2번째 : Dispatcher
		// request객체를 통해 getRequestDispatcher 메소드를 호출하여 requestDispatcher 객체를 확보
		//														(어떤 jsp, servlet에게 위임할지 인자를 전달)
		// requestDispatcher객체의 forward 메소드를 통해 다른 jsp(servlet)에게 응답생성을 위임
